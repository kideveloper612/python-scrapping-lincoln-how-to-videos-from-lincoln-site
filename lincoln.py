...
def excute_each_request():
    ...
    filename = "Lincoln_how_to_video.csv"
    ...
    for section in sections:
        ...
        for sub_section in sub_sections[section]:
            ...
            url = "https://owner.lincoln.com/support/lincoln/_jcr_content.cxht" + section_url + sub_section_url + '.json'
            print(url.strip())
            ...
            for record in records:
                ...
                video_url = "https://owner.lincoln.com" + record['contentPath'] + '.html'
                thumbnail_url = "https://owner.lincoln.com" + record['pageThumbnail']
                tags = record['tags']
                for tag in tags:
    ...
    write_csv([['YEAR', 'MAKE', 'MODEL', 'SECTION', 'SUB_SECTION', 'SYNC_VERSION' 'TITLE', 'DESCRIPTION', 'THUMBNAIL_URL', 'VIDEO_URL']], "Lincoln_how_to_video_Sorted.csv")
    write_csv(sorted_result, "Lincoln_how_to_video_Sorted.csv")
